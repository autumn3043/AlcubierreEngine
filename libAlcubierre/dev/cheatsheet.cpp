//By project convention (not spec or common convention), everything should be named according to camelCase. Capitalise the first letter of the names of classes, structs and enums.
...
class Example {
    public:
        ...
        //By project convention, initialisation list arguments are declared with _memberName, to indicate that they represent a temporary input value.
