        ...
        int CreateGraphicsPipelines();
            class graphicsPipeline {
                public:
                    ...
                    virtual int init(VkDevice& _device, VkFormat& format, std::vector<IShaders::AlcShader*>& shaders) = 0;
            ...
            class opaqueGeometryPipe : public graphicsPipeline {
                public:
                    int init(VkDevice& _device, VkFormat& format, std::vector<IShaders::AlcShader*>& shaders) override;
